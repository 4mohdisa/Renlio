...
import { mockProperties, mockContacts } from '@/lib/mock-data'
...
export default function NewWholePropertyTenancyPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
